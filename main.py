...
from data.dataset import BraTS2017
...
def train(**kwargs):
	...
	for epoch in range(opt.max_epoch):
		...
		# **************** save model ****************
		# if epoch % 10 == 0:
		torch.save(model.state_dict(), os.path.join(save_dir, 'epoch_{:d}.pth'.format(epoch)))
...
def datatest():
	dataset = BraTS2017(opt.train_root_path, opt.val_root_path, is_train=False)
